...
## Структура проекта
В данном проекте представлены основные результаты работы, выложена лучшая модель для предсказания гранулометрических свойств донного грунта по результатам экспериментов 
